...
\begin{frame}{Loss Functions}% Adjust width as needed}
    ...
    \begin{itemize}
        ...
        \item Compute the \textbf{Kolmogorov-Smirnov (KS) distance} between the final state distribution and the state distribution that accumulates all mass in the final state [(0,0,0,1)\textcolor{red}{$^\ast$}]
    \end{itemize}
        \item \colorbf{Why do the second one?} We want confident predictions
